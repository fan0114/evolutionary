fid = fopen('evo_p1/TSP2/GAp10i0.txt');
GAp10i0 = fscanf(fid, '%g|%d', [2 inf]);
fclose(fid);
fid = fopen('evo_p1/TSP2/GAp10i1.txt');
GAp10i1 = fscanf(fid, '%g|%d', [2 inf]);
fclose(fid);
fid = fopen('evo_p1/TSP2/GAp10i2.txt');
...
axis([2000 1000000 8 13])
hold all;
%figure(2);
fid = fopen('evo_p1/TSP2/GAp100i0.txt');
GAp100i0 = fscanf(fid, '%g|%d', [2 inf]);
fclose(fid);
fid = fopen('evo_p1/TSP2/GAp100i1.txt');
GAp100i1 = fscanf(fid, '%g|%d', [2 inf]);
fclose(fid);
fid = fopen('evo_p1/TSP2/GAp100i2.txt');
...
%figure(3);
fid = fopen('evo_p1/TSP2/GAp1000i0.txt');
GAp1000i0 = fscanf(fid, '%g|%d', [2 inf]);
fclose(fid);
fid = fopen('evo_p1/TSP2/GAp1000i1.txt');
GAp1000i1 = fscanf(fid, '%g|%d', [2 inf]);
fclose(fid);
fid = fopen('evo_p1/TSP2/GAp1000i2.txt');
